...
define(["ojs/ojcore", "jquery", "promise", "ojs/ojdatacollection-common"], function($oj$$18$$, $$$$17$$) {
  ...
  $oj$$18$$.$DataColumnCube$.prototype.$_buildAggTypeLookup$ = function $$oj$$18$$$$DataColumnCube$$$$_buildAggTypeLookup$$() {
    ...
    if (this.$_aggregation$) {
      for (var $i$$290$$ = 0;$i$$290$$ < this.$_aggregation$.length;$i$$290$$++) {
        var $dv$$ = this.$_aggregation$[$i$$290$$], $agg$$1$$ = $dv$$.aggregation;
  ...
  $oj$$18$$.$DataValueAttributeCube$.prototype.$_buildAggTypeLookup$ = function $$oj$$18$$$$DataValueAttributeCube$$$$_buildAggTypeLookup$$() {
    this.$_dataValueAggType$ = [];
    for (var $i$$291$$ = 0;$i$$291$$ < this.$_dataValues$.length;$i$$291$$++) {
      var $dv$$1$$ = this.$_dataValues$[$i$$291$$];
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.getData = function $$oj$$18$$$$CubeHeaderSet$$$getData$($index$$151$$, $level$$35$$) {
    var $val$$46$$ = this.$_getValue$($index$$151$$, $level$$35$$);
  ...
  $oj$$18$$.$CubeHeaderSet$.prototype.$getExtent$ = function $$oj$$18$$$$CubeHeaderSet$$$$getExtent$$($index$$153$$, $level$$37$$) {
    var $start$$38_val$$47$$ = this.$_getValue$($index$$153$$, $level$$37$$), $extent$$ = $start$$38_val$$47$$.$getExtent$(), $start$$38_val$$47$$ = $start$$38_val$$47$$.$getStart$(), $end$$14$$ = $start$$38_val$$47$$ + $extent$$ - 1, $after$$ = $index$$153$$ < $start$$38_val$$47$$ + $extent$$ - 1;
    $start$$38_val$$47$$ < this.$_start$ && ($extent$$ -= this.$_start$ - $start$$38_val$$47$$);
    $end$$14$$ > this.$_end$ && ($extent$$ -= $end$$14$$ - this.$_end$);
    return{extent:$extent$$, more:{before:$index$$153$$ > $start$$38_val$$47$$, after:$after$$}};
  };
  ...
  $oj$$18$$.$CubeDataGridDataSource$.prototype.$fetchCells$ = function $$oj$$18$$$$CubeDataGridDataSource$$$$fetchCells$$($cellRange$$5$$, $callbacks$$35$$, $callbackObjects$$21$$) {
    for (var $cubecells_obj$$54$$ = {}, $i$$292$$ = 0;$i$$292$$ < $cellRange$$5$$.length;$i$$292$$++) {
      var $start$$39$$ = void 0 === $cellRange$$5$$[$i$$292$$].start ? 0 : $cellRange$$5$$[$i$$292$$].start;
      if ("row" === $cellRange$$5$$[$i$$292$$].axis) {
        var $count$$34$$ = void 0 === $cellRange$$5$$[$i$$292$$].count ? this.data.$getAxes$()[1].$getExtent$() : $cellRange$$5$$[$i$$292$$].count;
        $cubecells_obj$$54$$.row = {start:$start$$39$$, count:$count$$34$$};
      }
      "column" === $cellRange$$5$$[$i$$292$$].axis && ($count$$34$$ = void 0 === $cellRange$$5$$[$i$$292$$].count ? this.data.$getAxes$()[0].$getExtent$() : $cellRange$$5$$[$i$$292$$].count, $cubecells_obj$$54$$.column = {start:$start$$39$$, count:$count$$34$$});
    }
