...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/internal-deps/dvt/DvtToolkit"], function($oj$$15$$, $$$$15$$, $comp$$4$$, $val$$40$$, $dvt$$1$$) {
  function $DvtJsonPath$$($object$$5$$, $path$$9$$) {
    this.$_path$ = $path$$9$$;
    this.$_root$ = $object$$5$$;
    this.$_delimiter$ = "/";
  }
  ...
  var $DvtStyleProcessor$$ = {CSS_TEXT_PROPERTIES:function($cssDiv$$) {
    ...
    var $cssObj$$1$$ = {}, $value$$199$$ = $cssDiv$$6$$.css("font-family");
    $value$$199$$ && $value$$199$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_FAMILY$ && ($cssObj$$1$$["font-family"] = $value$$199$$.replace(/"/g, "'"));
    $value$$199$$ = $cssDiv$$6$$.css("font-size");
    !$value$$199$$ || -1 < $value$$199$$.indexOf("px") && parseFloat($value$$199$$) < $DvtStyleProcessor$$.$_FONT_SIZE_BUFFER$ || $ignoreProperties$$1$$["font-size"] || ($cssObj$$1$$["font-size"] = $value$$199$$);
    ($value$$199$$ = $cssDiv$$6$$.css("font-weight")) && $value$$199$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_WEIGHT$ && !$ignoreProperties$$1$$["font-weight"] && ($cssObj$$1$$["font-weight"] = $value$$199$$);
    ($value$$199$$ = $cssDiv$$6$$.css("color")) && $value$$199$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_COLOR$ && !$ignoreProperties$$1$$.color && ($cssObj$$1$$.color = $value$$199$$);
    ($value$$199$$ = $cssDiv$$6$$.css("font-style")) && $value$$199$$ !== $DvtStyleProcessor$$.$_INHERITED_FONT_STYLE$ && ($cssObj$$1$$["font-style"] = $value$$199$$);
    return $cssObj$$1$$;
    ...
    for (var $i$$260$$ = 0;$i$$260$$ < $componentClasses_innerDummyDiv$$.length;$i$$260$$++) {
      $definitions_element$$93_styleClasses$$ = $definitions_element$$93_styleClasses$$ + $componentClasses_innerDummyDiv$$[$i$$260$$] + " ";
    }
    ...
    for (var $cssDiv$$7$$ = null, $i$$261$$ = 0;$i$$261$$ < $definitions$$1$$.length;$i$$261$$++) {
      var $definition_path$$8$$ = $definitions$$1$$[$i$$261$$], $property$$25_strValue$$ = $definition_path$$8$$.property;
      if ($property$$25_strValue$$) {
        var $value$$200$$ = $DvtStyleProcessor$$.$_styleCache$[$styleClass$$4$$][$property$$25_strValue$$];
        "undefined" == typeof $value$$200$$ && ($cssDiv$$7$$ || ($cssDiv$$7$$ = $$$$15$$(document.createElement("div")), $cssDiv$$7$$.addClass($styleClass$$4$$), $element$$94$$.append($cssDiv$$7$$)), $value$$200$$ = $DvtStyleProcessor$$.$_resolveStyle$($cssDiv$$7$$, $property$$25_strValue$$), $DvtStyleProcessor$$.$_styleCache$[$styleClass$$4$$][$property$$25_strValue$$] = $value$$200$$);
        if (null != $value$$200$$) {
          var $definition_path$$8$$ = new $DvtJsonPath$$($options$$294$$, $definition_path$$8$$.path), $handler$$48$$ = $DvtStyleProcessor$$[$property$$25_strValue$$];
          if (null != $handler$$48$$) {
            var $optionsValue$$ = $definition_path$$8$$.$getValue$();
            if ("CSS_URL" !== $property$$25_strValue$$) {
              $property$$25_strValue$$ = "";
              if (null != $optionsValue$$) {
                for (var $attr$$17$$ in $value$$200$$) {
                  -1 === $optionsValue$$.indexOf($attr$$17$$) && ($property$$25_strValue$$ += $attr$$17$$ + ":" + $value$$200$$[$attr$$17$$] + ";");
                }
                $property$$25_strValue$$ += $optionsValue$$;
              } else {
                for ($attr$$17$$ in $value$$200$$) {
                  $property$$25_strValue$$ += $attr$$17$$ + ":" + $value$$200$$[$attr$$17$$] + ";";
                }
              }
              $value$$200$$ = $property$$25_strValue$$;
            }
          }
          $definition_path$$8$$.$setValue$($value$$200$$, null != $handler$$48$$);
        }
      }
    }
  }, $_resolveStyle$:function($cssDiv$$8$$, $property$$26$$) {
    var $handler$$49_value$$201$$ = $DvtStyleProcessor$$[$property$$26$$], $handler$$49_value$$201$$ = $handler$$49_value$$201$$ ? $handler$$49_value$$201$$($cssDiv$$8$$) : $DvtStyleProcessor$$.$defaultStyleProcessor$($cssDiv$$8$$, $property$$26$$);
  ...
  $oj$$15$$.$__registerWidget$("oj.dvtBaseComponent", $$$$15$$.oj.baseComponent, {_ComponentCreate:function() {
    ...
    for (var $componentStyles$$ = this.$_GetComponentStyleClasses$(), $i$$262$$ = 0;$i$$262$$ < $componentStyles$$.length;$i$$262$$++) {
      this.element.addClass($componentStyles$$[$i$$262$$]);
    }
    ...
    if ($params$$17$$) {
      for (var $paramMap$$ = {}, $i$$263$$ = 0;$i$$263$$ < $params$$17$$.length;$i$$263$$++) {
        $paramMap$$[$params$$17$$[$i$$263$$]] = "{" + $i$$263$$ + "}";
      }
    ...
    for (var $componentStyles$$1$$ = this.$_GetComponentStyleClasses$(), $i$$264$$ = 0;$i$$264$$ < $componentStyles$$1$$.length;$i$$264$$++) {
      this.element.removeClass($componentStyles$$1$$[$i$$264$$]);
    }
    this._super();
    ...
    for (var $ret$$29$$ = "", $i$$265$$ = 0;$i$$265$$ < $indexPath$$.length;$i$$265$$++) {
      $ret$$29$$ += "[" + $indexPath$$[$i$$265$$] + "]";
    }
    return $ret$$29$$;
  ...
  $oj$$15$$.$ColorAttributeGroupHandler$ = function $$oj$$15$$$$ColorAttributeGroupHandler$$($matchRules$$3$$) {
    ...
    if ($$$$15$$(document.body).hasClass("oj-hicontrast")) {
      ...
      if (!$oj$$15$$.$ColorAttributeGroupHandler$.$_colors$) {
        ...
        for (var $i$$266$$ = 0;$i$$266$$ < $oj$$15$$.$ColorAttributeGroupHandler$.$_STYLE_CLASSES$.length;$i$$266$$++) {
          var $childDiv_color$$2$$ = $$$$15$$(document.createElement("div"));
          $childDiv_color$$2$$.addClass($oj$$15$$.$ColorAttributeGroupHandler$.$_STYLE_CLASSES$[$i$$266$$]);
  ...
  $DvtJsonPath$$.prototype.$_resolveLeafObjectAndProperty$ = function $$DvtJsonPath$$$$$_resolveLeafObjectAndProperty$$($root$$2$$, $path$$10$$, $delimiter$$, $createIfMissing$$) {
    for (var $result$$49$$ = {};$root$$2$$ && -1 < $path$$10$$.indexOf($delimiter$$);) {
      var $subProperty$$ = $path$$10$$.substring(0, $path$$10$$.indexOf($delimiter$$));
      $createIfMissing$$ && void 0 === $root$$2$$[$subProperty$$] && ($root$$2$$[$subProperty$$] = {});
      $root$$2$$ = $root$$2$$[$subProperty$$];
      $path$$10$$ = $path$$10$$.substring($path$$10$$.indexOf($delimiter$$) + 1, $path$$10$$.length);
    }
    $root$$2$$ && ($result$$49$$.object = $root$$2$$, $result$$49$$.parameter = $path$$10$$);
    return $result$$49$$;
  };
