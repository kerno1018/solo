...
define(["ojs/ojcore", "jquery", "knockout"], function($oj$$7$$, $$$$7$$, $ko$$1$$) {
  ...
  function $_handleManagedAttributes$$($i$$125_name$$80$$, $value$$148$$, $bindingContext$$3$$) {
    ...
    if ("pointDataLayers" === $i$$125_name$$80$$) {
      for ($i$$125_name$$80$$ = 0;$i$$125_name$$80$$ < $value$$148$$.length;$i$$125_name$$80$$++) {
        $template$$3$$ = $value$$148$$[$i$$125_name$$80$$].template, null != $template$$3$$ && ($value$$148$$[$i$$125_name$$80$$]._templateRenderer = $_getDataLayerRenderer$$($bindingContext$$3$$, $template$$3$$));
      }
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["header", "cell"], init:function($cellTemplate_column_name$$89_row$$, $value$$156$$, $columnTemplate_element$$45_rowTemplate$$, $widgetConstructor$$, $valueAccessor$$4$$, $allBindingsAccessor$$4$$, $bindingContext$$18$$) {
    if ("header" === $cellTemplate_column_name$$89_row$$) {
      return $cellTemplate_column_name$$89_row$$ = $value$$156$$.row, null != $cellTemplate_column_name$$89_row$$ && ($columnTemplate_element$$45_rowTemplate$$ = $cellTemplate_column_name$$89_row$$.template, null != $columnTemplate_element$$45_rowTemplate$$ && ($cellTemplate_column_name$$89_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$18$$, $columnTemplate_element$$45_rowTemplate$$))), $cellTemplate_column_name$$89_row$$ = $value$$156$$.column, null != $cellTemplate_column_name$$89_row$$ && 
      ($columnTemplate_element$$45_rowTemplate$$ = $cellTemplate_column_name$$89_row$$.template, null != $columnTemplate_element$$45_rowTemplate$$ && ($cellTemplate_column_name$$89_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$18$$, $columnTemplate_element$$45_rowTemplate$$))), {header:$value$$156$$};
    }
  ...
  }, update:function($cellTemplate$$1_column$$1_name$$90_row$$1$$, $value$$157$$, $columnTemplate$$1_element$$46_rowTemplate$$1$$, $widgetConstructor$$1$$, $valueAccessor$$5$$, $allBindingsAccessor$$5$$, $bindingContext$$19$$) {
    return "header" === $cellTemplate$$1_column$$1_name$$90_row$$1$$ ? ($cellTemplate$$1_column$$1_name$$90_row$$1$$ = $value$$157$$.row, null != $cellTemplate$$1_column$$1_name$$90_row$$1$$ && ($columnTemplate$$1_element$$46_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$90_row$$1$$.template, null != $columnTemplate$$1_element$$46_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$90_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$19$$, $columnTemplate$$1_element$$46_rowTemplate$$1$$))), 
    $cellTemplate$$1_column$$1_name$$90_row$$1$$ = $value$$157$$.column, null != $cellTemplate$$1_column$$1_name$$90_row$$1$$ && ($columnTemplate$$1_element$$46_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$90_row$$1$$.template, null != $columnTemplate$$1_element$$46_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$90_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$19$$, $columnTemplate$$1_element$$46_rowTemplate$$1$$))), {header:$value$$157$$}) : "cell" === $cellTemplate$$1_column$$1_name$$90_row$$1$$ ? 
  ...
  $ko$$1$$.bindingHandlers.ojContextMenu = {update:function $$ko$$1$$$bindingHandlers$ojContextMenu$update$($element$$47$$, $valueAccessor$$6$$) {
    ...
    var $$element$$ = $$$$7$$($element$$47$$), $$menu$$, $_menu$$, $pressHoldTimer$$, $isPressHold$$1$$ = !1, $touchInProgress$$1$$ = !1, $doubleOpenTimer$$1$$, $doubleOpenType$$1$$ = null, $clickListener$$;
    ...
    "string" !== $$$$7$$.type($menuSelector$$) && ($menuSelector$$ = $element$$47$$.getAttribute("contextmenu")) && ($menuSelector$$ = "#" + $menuSelector$$);
    $clickListener$$ = function $$clickListener$$$($event$$62$$) {
      if ($isPressHold$$1$$) {
        return $event$$62$$.preventDefault(), $event$$62$$.stopPropagation(), $isPressHold$$1$$ = !1;
      }
    };
    $element$$47$$.addEventListener("click", $clickListener$$, !0);
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["areaLayers", "pointDataLayers"], init:function($name$$91$$, $value$$158$$, $element$$48$$, $widgetConstructor$$2$$, $valueAccessor$$7$$, $allBindingsAccessor$$6$$, $bindingContext$$21$$) {
    return $_handleManagedAttributes$$($name$$91$$, $value$$158$$, $bindingContext$$21$$);
  }, update:function($name$$92$$, $value$$159$$, $element$$49$$, $widgetConstructor$$3$$, $valueAccessor$$8$$, $allBindingsAccessor$$7$$, $bindingContext$$22$$) {
    return $_handleManagedAttributes$$($name$$92$$, $value$$159$$, $bindingContext$$22$$);
  }, "for":"ojThematicMap"});
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["columns", "columnsDefault", "rowTemplate"], init:function($name$$93$$, $value$$160$$, $element$$50_i$$132$$, $template$$12_widgetConstructor$$4$$, $footerTemplate_valueAccessor$$9$$, $allBindingsAccessor$$8_headerTemplate$$, $bindingContext$$23$$) {
    if ("columns" == $name$$93$$ || "columnsDefault" == $name$$93$$) {
      for ($element$$50_i$$132$$ = 0;$element$$50_i$$132$$ < $value$$160$$.length;$element$$50_i$$132$$++) {
        var $column$$2$$ = $value$$160$$[$element$$50_i$$132$$];
  ...
  }, update:function($name$$94$$, $value$$161$$, $element$$51_i$$133$$, $widgetConstructor$$5$$, $template$$13_valueAccessor$$10$$, $allBindingsAccessor$$9_footerTemplate$$1$$, $bindingContext$$24$$) {
    if ("columns" == $name$$94$$ || "columnsDefault" == $name$$94$$) {
      var $headerTemplate$$1$$;
      for ($element$$51_i$$133$$ = 0;$element$$51_i$$133$$ < $value$$161$$.length;$element$$51_i$$133$$++) {
        var $column$$3$$ = $value$$161$$[$element$$51_i$$133$$];
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["template"], init:function($name$$95$$, $value$$162$$, $element$$52$$, $widgetConstructor$$6$$, $valueAccessor$$11$$, $allBindingsAccessor$$10$$, $bindingContext$$25$$) {
    return "template" === $name$$95$$ ? {_templateFunction:$_getDiagramNodeRenderer$$($bindingContext$$25$$, $value$$162$$)} : null;
  }, update:function($name$$96$$, $value$$163$$, $element$$53$$, $widgetConstructor$$7$$, $valueAccessor$$12$$, $allBindingsAccessor$$11$$, $bindingContext$$26$$) {
    return "template" === $name$$96$$ ? {_templateFunction:$_getDiagramNodeRenderer$$($bindingContext$$26$$, $value$$163$$)} : null;
  }, "for":"ojDiagram"});
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["item"], init:function($name$$97_result$$16$$, $value$$164$$, $element$$54$$, $widgetConstructor$$8$$, $valueAccessor$$13$$, $allBindingsAccessor$$12$$, $bindingContext$$27$$) {
