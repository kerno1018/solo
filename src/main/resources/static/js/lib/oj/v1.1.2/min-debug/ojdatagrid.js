...
define(["ojs/ojcore", "jquery", "ojs/internal-deps/datagrid/DvtDataGrid", "ojs/ojcomponentcore", "ojs/ojdatacollection-common", "ojs/ojinputnumber", "ojs/ojmenu", "ojs/ojdialog", "ojs/ojpagingcontrol"], function($oj$$11$$, $$$$11$$, $DvtDataGrid$$1$$) {
  ...
  $oj$$11$$.$FlattenedTreeDataGridDataSource$.prototype.$insertRows$ = function $$oj$$11$$$$FlattenedTreeDataGridDataSource$$$$insertRows$$($event$$123_insertAtIndex$$, $cellSet$$2_insertAtRowKey$$, $nodeSet$$7$$) {
    var $headerSet$$3$$, $i$$175$$, $keys$$12$$, $indexes$$10$$;
    $headerSet$$3$$ = null;
    this.$m_rowHeader$ && ($headerSet$$3$$ = new $oj$$11$$.$FlattenedTreeHeaderSet$($event$$123_insertAtIndex$$, $event$$123_insertAtIndex$$ + $nodeSet$$7$$.$getCount$(), this.$m_columns$, $nodeSet$$7$$, this.$m_rowHeader$));
    $cellSet$$2_insertAtRowKey$$ = new $oj$$11$$.$FlattenedTreeCellSet$($event$$123_insertAtIndex$$, $event$$123_insertAtIndex$$ + $nodeSet$$7$$.$getCount$(), 0, this.$m_columns$.length, $nodeSet$$7$$, this.$m_columns$);
    $keys$$12$$ = [];
    $indexes$$10$$ = [];
    for ($i$$175$$ = 0;$i$$175$$ < $nodeSet$$7$$.$getCount$();$i$$175$$++) {
