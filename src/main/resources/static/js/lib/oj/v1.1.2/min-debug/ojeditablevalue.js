...
define(["ojs/ojcore", "jquery", "hammerjs", "ojs/ojjquery-hammer", "ojs/ojcomponentcore", "ojs/ojvalidation", "ojs/ojpopup"], function($oj$$4$$, $$$$4$$, $Hammer$$1$$) {
  ...
  $oj$$4$$.$__registerWidget$("oj.editableValue", $$$$4$$.oj.baseComponent, {widgetEventPrefix:"oj", options:{disabled:!1, displayOptions:void 0, help:{definition:null, source:null}, messagesCustom:void 0, messagesHidden:void 0, messagesShown:void 0, required:void 0, title:void 0, validators:void 0, value:void 0}, getNodeBySubId:function($locator$$4$$) {
  ...
  }, $_SetRawValue$:function($event$$39$$, $val$$20$$) {
    var $flags$$11$$ = {};
    $flags$$11$$._context = {originalEvent:$event$$39$$, $writeback$:!0, $internalSet$:!0};
  ...
  }, $_SetValue$:function($newValue_parsed$$, $event$$40$$, $options$$125$$) {
    ...
    if ($doValueChangeCheck$$ && $newValue_parsed$$ === this.$_oj_lastElementValue$) {
      ...
      if ($newValue_parsed$$ = this.$_Validate$($newValue_parsed$$, $event$$40$$, $options$$125$$), void 0 !== $newValue_parsed$$ && this.isValid()) {
        return this.$_updateValueOption$($newValue_parsed$$, $event$$40$$, $options$$125$$ && $options$$125$$.$validationContext$), !0;
      }
    }
    return!1;
  }, $_Validate$:function($newValue$$1$$, $event$$41$$, $doNotClearMessages$$1_options$$126$$) {
    ...
    if (void 0 === $newValue$$1$$) {
      ...
      if (this.$_CanSetValue$()) {
        $doNotClearMessages$$1_options$$126$$ || this.$_clearAllMessages$($event$$41$$);
        this.$_setLastSubmittedValue$($newValue$$1$$);
        try {
          return this.$_runNormalValidation$($newValue$$1$$, $mode$$11$$, $context$$36$$, $event$$41$$);
        } catch ($e$$30$$) {
        }
      } else {
    ...
    return "";
  }, $_MESSAGING_CONTENT_UPDATE_TYPE$:{$ALL$:1, $VALIDITY_STATE$:2, $CONVERTER_HINT$:3, $VALIDATOR_HINTS$:4, $TITLE$:5}, $_OPTION_TO_CSS_MAPPING$:{disabled:"oj-disabled", required:"oj-required"}, $_clearAllMessages$:function($event$$42$$, $doNotSetOption$$) {
    $doNotSetOption$$ ? (this.options.messagesHidden = [], this.options.messagesShown = [], this.options.messagesCustom = []) : (this.$_clearMessages$("messagesHidden", $event$$42$$), this.$_clearMessages$("messagesShown", $event$$42$$), this.$_clearMessages$("messagesCustom", $event$$42$$));
  ...
  }, $_setMessagesOption$:function($key$$35$$, $value$$84$$, $event$$43$$, $changed$$1$$) {
    var $flags$$12$$ = {}, $bothEmpty$$ = 0 === $value$$84$$.length && 0 === this.options[$key$$35$$].length;
    if ($changed$$1$$ || !$bothEmpty$$) {
      $flags$$12$$._context = {originalEvent:$event$$43$$, $writeback$:!0, $internalSet$:!0}, $flags$$12$$.changed = $changed$$1$$ || !$bothEmpty$$, this.$_resetValid$(), this.option($key$$35$$, $value$$84$$, $flags$$12$$), this.$_updateMessagingContent$();
    }
  }, $_clearMessages$:function($option$$7$$, $event$$44$$) {
    this.$_setMessagesOption$($option$$7$$, [], $event$$44$$);
  }, $_cloneMessagesBeforeSet$:function($value$$85$$) {
    var $msg$$6_val$$21$$, $msgsClone$$ = [], $i$$99$$;
    if ($value$$85$$ && 0 < $value$$85$$.length) {
      for ($i$$99$$ = 0;$i$$99$$ < $value$$85$$.length;$i$$99$$++) {
        $msg$$6_val$$21$$ = $value$$85$$[$i$$99$$], $msg$$6_val$$21$$ instanceof $oj$$4$$.$Message$ ? $msgsClone$$.push($msg$$6_val$$21$$.clone()) : ($msg$$6_val$$21$$ = new $oj$$4$$.$Message$($msg$$6_val$$21$$.summary, $msg$$6_val$$21$$.detail, $msg$$6_val$$21$$.severity), $msg$$6_val$$21$$ = Object.freeze ? Object.freeze($msg$$6_val$$21$$) : $msg$$6_val$$21$$, $msgsClone$$.push($msg$$6_val$$21$$));
      }
    }
    return $msgsClone$$;
    ...
    var $customMsgs$$ = this.options.messagesCustom, $shownMsgs$$1$$ = [], $msg$$8$$, $i$$101$$, $previousShown$$ = this.options.messagesShown, $context$$37$$ = $flags$$13$$ ? $flags$$13$$._context : null;
  ...
  }, $_updateMessagesOption$:function($option$$8$$, $newMsgs$$, $event$$45$$) {
    ...
    this.$_setMessagesOption$($option$$8$$, $msgs$$1$$, $event$$45$$, !0);
  }, $_updateMessagingContent$:function() {
    this.$_getComponentMessaging$().update(this.$_getMessagingContent$());
  }, $_updateValueOption$:function($newValue$$2$$, $event$$46$$, $validationContext$$) {
    var $context$$39$$ = {};
    $event$$46$$ && ($context$$39$$.originalEvent = $event$$46$$);
  ...
  }, $_runNormalValidation$:function($newMsgs$$2_value$$92$$, $mode$$12$$, $context$$42$$, $event$$47$$) {
    ...
    try {
      ...
      throw $newMsgs$$2_value$$92$$ = this.$_processValidationErrors$($ve$$1$$, $context$$42$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$2_value$$92$$, $event$$47$$), $ve$$1$$;
    }
    return $newValue$$4$$;
  ...
  }, $_updateElementDisplayValue$:function($modelValue$$1$$, $event$$48$$) {
    ...
    try {
      ...
      $newMsgs$$3$$ = this.$_processValidationErrors$($e$$33$$), this.$_updateMessagesOption$("messagesShown", $newMsgs$$3$$, $event$$48$$);
    }
    ...
    $oj$$4$$.$__registerWidget$("oj._ojLabel", $$$$4$$.oj.baseComponent, {version:"1.0.0", defaultElement:"\x3clabel\x3e", widgetEventPrefix:"oj", options:{ariaRequiredUnsupported:!1, describedById:null, help:{definition:null, source:null}, required:!1, rootAttributes:null}, $_BUNDLE_KEY$:{$_TOOLTIP_HELP$:"tooltipHelp", $_TOOLTIP_REQUIRED$:"tooltipRequired"}, widget:function() {
      ...
      if (0 != $helpIcon$$.length) {
        ...
        this.$_openPopupForHelpDefCallbackListener$ || (this.$_openPopupForHelpDefCallbackListener$ = function $this$$_openPopupForHelpDefCallbackListener$$($event$$50$$) {
          $self$$39$$.$_handleOpenPopupForHelpDef$($event$$50$$, $helpDefPopupDiv$$, $helpIcon$$, !1);
        });
